...
function Header( { onSearch }) {
    ...
    useEffect(() => {
        fetch('https://sv4lxv-8080.csb.app/books')
            ...
            <div className="header flex items-center py-2 pb-3 mb-2 hideMb hideSm">
                ...
                <div className="header__cart mx-4 hideSm">
                    <div className="header__cart-wrap">
                        ...
                        <span className="header__cart-notice flex items-center justify-center">2</span>
                        ...
                        <div className="header__cart-list">
                            ...
                            <ul className="header__cart-list-item">
                                <li className="header__cart-item">
                                    <img src="https://salt.tikicdn.com/ts/product/5e/18/24/2a6154ba08df6ce6161c13f4303fa19e.jpg" alt="" className="header__cart-img" />
                                    <div className="header__cart-item-info">
                                        <div className="header__cart-item-head">
                                            <h5 className="header__cart-item-name">Cây Cam Ngọt Của Tôi - Tái bản lần 2</h5>
                                            <div className="header__cart-item-price-wrap">
                                                <span className="header__cart-item-price">108.000đ</span>
